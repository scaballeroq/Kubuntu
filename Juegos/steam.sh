#!/bin/bash
# steam.sh - Instalación de Steam, Lutris y Proton para Kubuntu

set -euo pipefail

echo "🎮 Configurando entorno de Gaming para Kubuntu..."

# 1. Intentar instalar Steam NATIVO
...
echo "✅ Entorno de Gaming en Kubuntu configurado correctamente."
