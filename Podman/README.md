...
```bash
# En ~/.bashrc o ~/.zshrc
export PATH="$HOME/Workspace/Repositorios/Linux/Kubuntu/Podman/lib:$PATH"
```

O crea un alias:

```bash
alias podman-utils="$HOME/Workspace/Repositorios/Linux/Kubuntu/Podman/lib/podman-utils.sh"
```
