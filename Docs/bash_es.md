...
### 🖥️ Virtualización KVM/Libvirt
- `vms`: Lista todas las máquinas virtuales (`virsh list --all`).
- `vmstart <vm>`: Inicia una máquina virtual.
- `vmstop <vm>`: Apaga ordenadamente una máquina virtual.
- `vminfo <vm>`: Información detallada de la máquina virtual.
